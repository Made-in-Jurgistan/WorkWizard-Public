...
<p>
  ...
  <img src="https://img.shields.io/badge/status-pre--pilot%20MVP-D97706" alt="Status: Pre-pilot MVP" />
  <br />
  <img src="https://img.shields.io/badge/code%20contributions-not%20accepted-D97706" alt="Code Contributions: Not Accepted" />
  <img src="https://img.shields.io/badge/bug%20reports-welcome-2EA44F?logo=github&logoColor=white" alt="Bug Reports Welcome" />
  <img src="https://img.shields.io/badge/feature%20suggestions-welcome-7C3AED" alt="Feature Suggestions Welcome" />
</p>
...
- Pull requests with source code (the codebase is proprietary)
- Contributions that reveal exercise answers or bypass answer protection
- Suggestions that require exposing internal architecture or infrastructure

## Issue Guidelines

- Search existing issues before opening a new one
- One issue per problem or suggestion
